...
export interface LambdaWebAdapterWithExtensionStackProps extends EnforcedStackProps {
  extensionName: string,
  streamName: string,
  description?: string
}

export class LambdaWebAdapterWithExtensionStack extends EnforcedStack {

  constructor(scope: Construct, id: string, props: LambdaWebAdapterWithExtensionStackProps) {
